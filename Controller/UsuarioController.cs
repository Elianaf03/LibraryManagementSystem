...
namespace Controller
{
    public class UsuarioController
    {
        ...
        {
            return usuarioDao.obtnerFoto(idUsuario);
        }
        ...
        public DataTable ListarUsuariosFiltrado(string storp, string paramo)
        {
            return usuarioDao.listarUsuariosFiltrado(storp, paramo);
        }
        public Usuario ObtenerUsuarioXId(int idUsuario)
        {
            return usuarioDao.obtenrUsuarioXId(idUsuario);
        }
    }
}
